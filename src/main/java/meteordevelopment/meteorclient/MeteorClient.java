...
import meteordevelopment.meteorclient.systems.modules.misc.MinNotifications;
import meteordevelopment.meteorclient.systems.modules.render.ChinaHat;
import meteordevelopment.meteorclient.systems.modules.render.HitMarkers;
import meteordevelopment.meteorclient.systems.modules.render.JumpCircles;
import meteordevelopment.meteorclient.systems.modules.render.KillEffects;
...
public class MeteorClient implements ClientModInitializer {
    ...
    public static final String AUTHOR = "Minju26";
    ...
    public void onInitializeClient() {
        ...
        if (!FOLDER.exists()) {
            ...
            Systems.addPreLoadTask(() -> {
                ...
                Modules.get().get(MinNotifications.class).enable();
                Modules.get().get(HitMarkers.class).enable();
                Modules.get().get(ChinaHat.class).enable();
                Modules.get().get(JumpCircles.class).enable();
                Modules.get().get(KillEffects.class).enable();
            });
        }
